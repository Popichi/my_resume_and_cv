...
\section{Projects}
  ...
  \resumeProjectHeading
    ...
    {\textbf{\color{blue}Differentiable Finite Volume Method}} {}
    \resumeItemListStart
      \resumeItem{In my master's thesis, I worked on \textbf{computational fluid dynamics (CFD)} simulations using the \textbf{finite volume method (FVM)}. I developed and coded the \textbf{finite volume method (FVM)} solutions for \textbf{{$\Phi_{Flow}$}}, a differentiable PDE solving framework for machine learning, and then published my results.}
    \resumeItemListEnd
